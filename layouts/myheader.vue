    ...
    <div class="header-container">
        ...
        <!-- logo -->
            <div class="left-wrapper v-link selected">
                ...
                <span class="text">Medical Scheduling Center</span>
            </div>
        <!-- 搜索框 -->
        ...
        <el-dropdown v-if="name != ''" @command="loginMenu">
            ...
            <el-dropdown-item command="/user">User Auth</el-dropdown-item>
            <el-dropdown-item command="/order">Schedule Order</el-dropdown-item>
        ...
        <div class="operate-view" v-if="dialogAtrr.showLoginType === 'phone'">
          <div class="wrapper" style="width: 100%">
            ...
            <div class="bottom">
              ...
              <span class="third-text"> Third Party Login </span></div>
          </div>
        </div>
        <!-- 手机登录 #end -->
...
import hospitalApi from '@/api/hosp' //eslint-disable-line no-unused-vars

const defaultDialogAtrr = {
  showLoginType: 'phone', // 控制手机登录与微信登录切换

  labelTips: 'EMAIL ADDRESS', // 输入框提示

  inputValue: '', // 输入框绑定对象
  placeholder: 'Please enter your email', // 输入框placeholder
  maxlength: 32, // 输入框长度控制

  loginBtn: 'Access Code', // 登录按钮或获取验证码按钮文本
...
export default {
  ...
  mounted(){
    ...
    loginEvent.$on('loginDialogEvent', function () { //eslint-disable-line no-undef
  ...
  methods: {
    ...
    btnClick() {
      // 判断是获取验证码还是登录
      if(this.dialogAtrr.loginBtn == 'Access Code') {
    ...
    weixinLogin() {
      ...
      weixinApi.getLoginParam().then(response => {
        var obj = new WxLogin({ //eslint-disable-line no-unused-vars, no-undef
          self_redirect:true,
