    ...
    <div class="nav-container page-component">
      ...
      <div class="nav left-nav">
        <div class="nav-item selected">
          <span class="v-link selected dark" :onclick="'javascript:window.location=\'/hosp/'+schedule.hoscode+'\''">Make Appointment </span>
        </div>
        <div class="nav-item ">
          <span class="v-link clickable dark" :onclick="'javascript:window.location=\'/hosp/detail/'+schedule.hoscode+'\''"> 医院详情 </span>
        </div>
        <div class="nav-item">
          <span class="v-link clickable dark" :onclick="'javascript:window.location=\'/hosp/notice/'+schedule.hoscode+'\''"> 预约须知 </span>
        </div>
    ...
    methods: {
      ...
      submitOrder() {
        if(this.submitBnt == '正在提交'){
            this.$message.error('Do not submit again')
        }
        this.submitBnt = 'Now processing'
        orderApi.saveOrders(this.scheduleId,this.patient.id).then(
            reponse => {
                let orderId = reponse.data // order id
                window.location.href = '/order/show?orderId=' + orderId
            }
        ).catch(e => { //eslint-disable-line no-unused-vars
            this.submitBnt = 'Order Confirmed'
        })
      },
